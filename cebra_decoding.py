...
parser.add_argument('--offset', type=int, default=1, help='Offset to use')
parser.add_argument('--temp_mode', type=str, default='auto', help='Temperature mode to use')
parser.add_argument('--decoder', type=str, default='knn', help='Decoder to use')
...
max_iterations = np.arange(15000, 30000, 2000) #default is 5000.
output_dimension = [8] #here, we set as a variable for hypothesis testing below.
...
for max_iter in max_iterations:
    for out_dim in output_dimension:
        ...
        with open(os.path.join(save_dir, f'cebra_results_{OFFSET}_{TEMP_MODE}_{args.decoder}_lr:{args.lr}.pkl'), 'wb') as f:
